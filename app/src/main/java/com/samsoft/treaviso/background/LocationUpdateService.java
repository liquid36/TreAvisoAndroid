package com.samsoft.treaviso.background;
...
public class LocationUpdateService extends Service implements LocationListener {
    ...
    private static final String STATIONARY_REGION_ACTION        = "com.samsoft.treaviso.background.STATIONARY_REGION_ACTION";
    private static final String STATIONARY_ALARM_ACTION         = "com.samsoft.treaviso.background.STATIONARY_ALARM_ACTION";
    private static final String SINGLE_LOCATION_UPDATE_ACTION   = "com.samsoft.treaviso.background.SINGLE_LOCATION_UPDATE_ACTION";
    private static final String STATIONARY_LOCATION_MONITOR_ACTION = "com.samsoft.treaviso.background.STATIONARY_LOCATION_MONITOR_ACTION";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) { 
            ...
            Intent main = new Intent(this, com.samsoft.treaviso.app.MainActivity.class);
    ...
    */
    ...
    private boolean postLocation(com.samsoft.treaviso.background.data.Location l) {
        if (l == null) {
    ...
    private void persistLocation(Location location) {
        ...
        com.samsoft.treaviso.background.data.Location savedLocation = com.samsoft.treaviso.background.data.Location.fromAndroidLocation(location);
	...
	public void verifiedAlarm(com.samsoft.treaviso.background.data.Location l)
    {
        ...
        for (com.samsoft.treaviso.background.data.Alarm alarm : locationDAO.getActiveAlarm()) {
    ...
    private class PostLocationTask extends AsyncTask<Object, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Object...objects) {
            ...
            LocationDAO locationDAO = DAOFactory.createLocationDAO(LocationUpdateService.this.getApplicationContext());
            for (com.samsoft.treaviso.background.data.Location savedLocation : locationDAO.getAllLocations()) {
